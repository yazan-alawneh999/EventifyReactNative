            ...
            >
                <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <TextInput style={styles.input} placeholder={firstName} placeholderTextColor={'#546cfc'} onChangeText={setFirstName} />
                    </View>

                    <View style={styles.inputContainer}>
                        <Text style={styles.label}>Last Name</Text>
                        <TextInput style={styles.input} placeholder={lastName} placeholderTextColor={'#546cfc'} onChangeText={setLastName} />
                    </View>

                    <View style={styles.inputContainer}>
                        <Text style={styles.label}>Your Age</Text>
                        <TextInput style={styles.input} placeholder={String(userAge)} placeholderTextColor={'#546cfc'} keyboardType="numeric" maxLength={2} onChangeText={setUserAge} />
                    </View>

                    <View style={styles.inputContainer}>
                        <Text style={styles.label}>Your Address</Text>
                        <TextInput style={styles.input} placeholderTextColor={'#546cfc'} placeholder={city} onChangeText={setCity} />
                    </View>

                    <View style={styles.inputContainer}>
                        <Text style={styles.label}>Email address</Text>
                        <TextInput style={styles.input} placeholderTextColor={'#546cfc'} placeholder={email} autoCapitalize="none" keyboardType="email-address" onChangeText={(text) => {
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <TextInput style={styles.input} placeholderTextColor={'#546cfc'} placeholder={userNamr} autoCapitalize="none" keyboardType="email-address" onChangeText={setUserName} />
                    </View>
                    ...
                    <View style={styles.inputContainer}>
                        ...
                        <View style={styles.phoneContainer}>
                            ...
                            <TextInput style={styles.phoneInput} placeholder={String(phoneNumber)} placeholderTextColor={'#546cfc'} keyboardType="phone-pad" maxLength={9} onChangeText={setphoneNumber} />
                        </View>
                    </View>

                    <TouchableOpacity style={[styles.saveButton, { backgroundColor: isFormValid() ? '#546cfc' : '#ccc' }]} onPress={UpdateProfile} disabled={!isFormValid()}>
