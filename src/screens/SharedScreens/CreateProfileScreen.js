    ...
    <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
            ...
            <View style={styles.inputContainer}>
                ...
                <TextInput style={styles.input} placeholder="User" placeholderTextColor={'#546cfc'} onChangeText={setFirstName}/>
            </View>

            <View style={styles.inputContainer}>
                <Text style={styles.label}>Last Name</Text>
                <TextInput style={styles.input} placeholder="Family" placeholderTextColor={'#546cfc'} onChangeText={setLastName}/>
            </View>

            <View style={styles.inputContainer}>
                <Text style={styles.label}>Your Age</Text>
                <TextInput style={styles.input} placeholder="Your age" placeholderTextColor={'#546cfc'} keyboardType="numeric" maxLength={2} onChangeText={setUserAge}/>
            </View>

            <View style={styles.inputContainer}>
                <Text style={styles.label}>Your Address</Text>
                <TextInput style={styles.input} placeholderTextColor={'#546cfc'} placeholder="city,jordan" onChangeText={setCity} />
            </View>

            <View style={styles.inputContainer}>
                <Text style={styles.label}>Email address</Text>
                <TextInput style={styles.input} placeholderTextColor={'#546cfc'} placeholder="A12@ex.com"  autoCapitalize="none" keyboardType="email-address" onChangeText={(text) => {
            ...
            <View style={styles.inputContainer}>
                ...
                <View style={styles.phoneContainer}>
                    ...
                    <TextInput style={styles.phoneInput} placeholder="78999999" placeholderTextColor={'#546cfc'} keyboardType="phone-pad" maxLength={9} onChangeText={setphoneNumber}/>
                </View>
            </View>

            <TouchableOpacity style={[styles.saveButton , { backgroundColor: isFormValid() ? '#546cfc' : '#ccc' }]}  onPress={createProfile} disabled={!isFormValid()}>
